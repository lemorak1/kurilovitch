...
const CursoEjemploAleman = () => {
  ...
  return (
    <>
      <Head>
        <title>Curso de Alemán para Principiantes - Kourilovitch Institute</title>
        <meta name="description" content="Aprende alemán desde cero con nuestro curso introductorio del Kourilovitch Institute." />
        <meta property="og:title" content="Curso de Alemán para Principiantes - Kourilovitch Institute" />
        <meta property="og:description" content="Aprende alemán desde cero con nuestro curso introductorio del Kourilovitch Institute." />
        <meta property="og:image" content="/imagenes/Courses/Aleman/P_Principiantes.jpg" />
      </Head>
      <div>
         {/* Sección Principal */}
      ...
      {/* <TextoImagen
        ...
        <SliderLevels
          title="Explora los Niveles para Principiantes"
          subtitle="Conoce las opciones disponibles para comenzar tu aprendizaje del alemán."
          levels={levels}
        ...
        <FormularioAgendarClase
          colorFondo={bg_color}
          curso="Agenda una clase gratuita en nuestro Curso de Alemán para Principiantes"
        />
      </div>
    </>
  );
...
export default CursoEjemploAleman;
